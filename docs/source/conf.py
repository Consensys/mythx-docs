...
htmlhelp_basename = 'MythXDevelopersGuidedoc'
...
latex_documents = [
    (master_doc, 'MythXDevelopersGuide.tex', 'MythX Developer\'s Guide Documentation',
...
man_pages = [
    (master_doc, 'mythxdevelopersguide', 'MythX Developer\'s Guide Documentation',
     [author], 1)
]
